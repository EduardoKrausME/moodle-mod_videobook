...
require_once($CFG->dirroot . '/mod/videobook/backup/moodle2/restore_videobook_stepslib.php');

/**
 * Defines the activity restore task.
 */
class restore_videobook_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps(): void {
        $this->add_step(new restore_videobook_activity_structure_step('videobook_structure', 'videobook.xml'));
    }
